...
- [[gultekin-pinarbasi-commercialisation-ai-2025]] — only 1 of the 10 Turkish AI-startups falls in this pattern; the sparseness is itself evidence consistent with the "squeezed middle" reading.
- [[software-as-temporary-artefacts]] — the squeeze tightens from a third direction: AI-first buyer firms ([[ai-first-company-loop]]) synthesise middle-layer tooling on demand inside their own operating loop. Weber Pattern 2 firms positioned as *primitives for synthesis* (RL APIs, agent frameworks, eval tooling) survive; those positioned as *finished workflow products* lose buyers to in-house substitution. This refines the 2021 → 2026 vintage problem above by adding the in-house-substitute mechanism alongside the frontier-lab-cannibalisation mechanism.
- [[ai-first-company-loop]] — the operating model whose tool layer is the substitution engine.
