...
- [[H5_ai-as-operational-not-product]] — surfaces a further candidate dimension: Weber's 2021 box is *seller-side only* and has no slot for the operator-builder (the AI-native firm that sells something else); this is structurally the gap on which H5 stands.
